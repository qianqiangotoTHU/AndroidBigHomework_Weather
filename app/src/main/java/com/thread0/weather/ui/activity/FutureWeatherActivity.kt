...
import com.thread0.weather.adapter.AdapterForDailyWeather
...
import kotlinx.android.synthetic.main.rv_item_weather_daily.*
...
class FutureWeatherActivity : SimpleActivity() {
    ...
    private lateinit var adapter: AdapterForDailyWeather
    ...
    private fun initRecyclerView(){
        ...
        adapter = AdapterForDailyWeather()
    ...
    private fun loadData() {
        ...
        launch{
            ...
            if(result != null){
                ...
                weather_layout.background=getDrawable(getSky(result0[0].code_day).bg)
                for(e in result0){
