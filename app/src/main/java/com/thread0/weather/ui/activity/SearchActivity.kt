...
import com.thread0.weather.adapter.AdapterForSearchLocation
...
class SearchActivity : AppCompatActivity() {
    private lateinit var adapterSearchLocation: AdapterForSearchLocation

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_search)
        setSupportActionBar(toolbar)
        adapterSearchLocation = AdapterForSearchLocation()
        ...
        launch {
            ...
            if (result != null) {
                adapterSearchLocation.setData(
                    result.results,
                    object : AdapterForSearchLocation.OnCityClickListener {
