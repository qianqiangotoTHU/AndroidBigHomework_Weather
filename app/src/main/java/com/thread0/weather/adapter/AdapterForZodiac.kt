...
class AdapterForZodiac : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.tv_back.background = mContext.getDrawable(getZodiac(list[position].zodiac).bg)
    }
